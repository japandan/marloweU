---
title: "MARLOWE with PEAKS on Sample set:multi_file_PEAKS_test.csv"
author: "Daniel Vogel"
date: "10/25/2022"
output:
  html_notebook:
...
#peaks_output_path <- choose.files(caption = "Select PEAKS de novo output csv",
#                                  multi = FALSE)
peaks_output_path <- "multi_file_PEAKS_test.csv"
...
Uploading tags to database
## check this https://jira.mariadb.org/browse/MDEV-20356
```{r upload-tags}
purrr::pwalk(
